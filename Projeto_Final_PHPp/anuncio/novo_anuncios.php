...
<!--Campo oculto para enviar o ID do aúncio-->
        ...
        <div class="form-group">
            ...
            <select name="id_categoria" required>
                ...
                <?php 
                $sql_categoria = "SELECT id, nome FROM categorias ORDER BY nome ASC";
                $resultado_categorias = $conexao->query($sql_categorias);
                while ($categoria = 
                $resultado_categorias->fetch_assoc()){
                $select = ($categoria['id'] == 
                $id_categoria_selecionada)? 'selected':'';
                echo"<option value'".$categoria['id']."'$selected>". htmlspecialchars($categoria['nome'])."<options>";
                }
        ...
        <div class="form_group">
            ...
            min="0" value="<?php echo htmlspecialchars($perco);?> "
        </div>
        <div class="form-group">
